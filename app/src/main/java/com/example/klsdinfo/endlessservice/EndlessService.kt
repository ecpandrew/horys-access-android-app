...
//        }
    ...
    private fun initCDDL() {
        try {
            ...
            connection.clientId = email
            connection.host = Connection.MICRO_BROKER_LOCAL_HOST
            connection.connect()

            cddl = CDDL.getInstance(). also {
            ...
            log("initCDDL() Failed: Unkown error!")
