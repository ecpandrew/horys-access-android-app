...
class FinalResultPeopleHistoryFragment : Fragment(), LifecycleOwner {

    companion object {
        fun newInstance(): FinalResultPeopleHistoryFragment {
            return FinalResultPeopleHistoryFragment()
        }
    }
